                            ...
                            <div key={index} className="py-3">
                                <div className="flex flex-col lg:flex-row w-full gap-5 md:gap-10">
                                    <div className="lg:basis-4/12">
                                        ...
                                        <p className="text-[15px] leading-none"> ●  {formatACFDate(exp.acf.start_date)} - {exp.acf.end_date ? formatACFDate(exp.acf.end_date) : "Present"}</p>
                                    </div>
                                    <div className="lg:basis-4/12">
                                    ...
                                    <div className="lg:basis-4/12">
                                        <div className="flex gap-[5px] justify-start lg:justify-end">
                                            {Object.values(exp.acf.technology).map((skill, index) => (
